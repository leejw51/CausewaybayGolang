...
local S = {
  ...
  title_help = {
    en = "1-7 jump straight in.   Q quest.   TAB Go/Rust.   F3 language.   F4 sound.   ESC quit.",
    ko = "1-7 바로 이동.   Q 퀘스트.   TAB Go/Rust.   F3 언어.   F4 소리.   ESC 종료.",
    yue = "1-7 直接跳去。  Q 任務。  TAB Go/Rust。  F3 語言。  F4 聲音。  ESC 離開。",
  },
  tagline_rust = {
  ...
  map_help = {
    en = "ARROWS walk    ENTER go    1-7 jump    Q quest    TAB Go/Rust    %s",
    ko = "방향키 이동    ENTER 입장    1-7 점프    Q 퀘스트    TAB Go/Rust    %s",
    yue = "方向鍵行    ENTER 入去    1-7 跳    Q 任務    TAB Go/Rust    %s",
  },
